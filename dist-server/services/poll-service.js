...
_defineProperty(PollService, "createPoll", /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(data) {
    var options, pollData, optionDocuments, createdOptions, optionIds, pollDataWithOptions, createdPoll;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          options = data.options, pollData = _objectWithoutProperties(data, _excluded); // Create options
          optionDocuments = options.map(function (option) {
            return {
              text: option
            };
          });
          _context4.next = 4;
          return _option["default"].insertMany(optionDocuments);
        case 4:
          createdOptions = _context4.sent;
          // Extract option IDs
          optionIds = createdOptions.map(function (option) {
            return option._id;
          }); // Add option IDs to poll data
          pollDataWithOptions = _objectSpread(_objectSpread({}, pollData), {}, {
            options: optionIds
          }); // Create poll
          _context4.next = 9;
          return _poll["default"].create(pollDataWithOptions);
        case 9:
          createdPoll = _context4.sent;
          return _context4.abrupt("return", createdPoll);
        case 11:
        case "end":
