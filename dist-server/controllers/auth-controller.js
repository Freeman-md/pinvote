...
var AuthController = /*#__PURE__*/_createClass(function AuthController() {
  ...
  _defineProperty(this, "showCreateAccountPage", function (req, res, next) {
    res.render('auth/create-account', {
      title: 'Create an account'
    });
  });
  _defineProperty(this, "showLoginPage", function (req, res, next) {
    res.render('auth/login', {
      title: 'Login'
    });
  });
  _defineProperty(this, "showForgotPasswordPage", function (req, res, next) {
    res.render('auth/forgot-password', {
      title: 'Forgot Password'
    });
  });
  _defineProperty(this, "showResetPasswordPage", function (req, res, next) {
    var validatedData = (0, _expressValidator.matchedData)(req);
    res.render('auth/reset-password', {
      title: 'Reset Password',
      queryData: validatedData,
      queryParamErrors: (0, _helpers.processValidationErrors)([]) // Empty array since validation is already done
    });
  });
  _defineProperty(this, "createAccount", /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 12:
            ...
            (0, _helpers.flashErrorsAndRedirect)(req, res, {
              errors: [{
  ...
  _defineProperty(this, "forgotPassword", /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res, next) {
      var _matchedData, email, _yield$AuthService$re, username, link;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            _matchedData = (0, _expressValidator.matchedData)(req), email = _matchedData.email;
            _context3.prev = 1;
            _context3.next = 4;
  ...
  _defineProperty(this, "resetPassword", /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res, next) {
      var _matchedData2, email, token, password, isResetPasswordComplete;
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            _matchedData2 = (0, _expressValidator.matchedData)(req), email = _matchedData2.email, token = _matchedData2.token, password = _matchedData2.password;
            _context4.prev = 1;
            _context4.next = 4;
            return _authService["default"].resetPassword(email, token, password);
          case 4:
            isResetPasswordComplete = _context4.sent;
