...
exports.showResetPasswordPage = exports.showLoginPage = exports.showForgotPasswordPage = exports.showCreateAccountPage = exports.resetPassword = exports.logout = exports.login = exports.forgotPassword = exports.createAccount = void 0;
...
var showResetPasswordPage = exports.showResetPasswordPage = function showResetPasswordPage(req, res, next) {
  ...
  var queryParamErrors;
  if (!errors.isEmpty()) {
    queryParamErrors = (0, _helpers.processValidationErrors)(errors.array());
  } else {
    validatedData = _objectSpread({}, (0, _expressValidator.matchedData)(req));
  }
  res.render('auth/reset-password', {
    title: 'Reset Password',
    queryData: validatedData,
    queryParamErrors: queryParamErrors
  });
};
...
var forgotPassword = exports.forgotPassword = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res, next) {
    var errors, _matchedData2, email, link;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          _matchedData2 = (0, _expressValidator.matchedData)(req), email = _matchedData2.email;
          _context3.prev = 4;
          _context3.next = 7;
          return _authService.AuthService.requestPasswordReset(email);
        case 7:
          link = _context3.sent;
          console.log(link);
...
var resetPassword = exports.resetPassword = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res, next) {
    var errors, _matchedData3, email, token, password, isResetPasswordComplete;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 3:
          _matchedData3 = (0, _expressValidator.matchedData)(req), email = _matchedData3.email, token = _matchedData3.token, password = _matchedData3.password;
          _context4.prev = 4;
          _context4.next = 7;
          return _authService.AuthService.resetPassword(email, token, password);
        case 7:
