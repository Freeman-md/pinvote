...
var VoteController = /*#__PURE__*/_createClass(function VoteController() {
  ...
  _defineProperty(this, "view", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
      var errors, _matchedData, pollId, votesByOption;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", flashErrorsAndRedirect(req, res, {
              errors: errors.array(),
              formData: {}
            }));
          case 3:
  ...
  _defineProperty(this, "vote", /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res, next) {
      var errors, _req$session, _req$session2, _matchedData2, pollId, option, poll;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 3:
            _context2.prev = 3;
            _matchedData2 = (0, _expressValidator.matchedData)(req), pollId = _matchedData2.id, option = _matchedData2.option;
            _context2.next = 7;
            return _pollService["default"].getPollDetails(pollId);
          case 7:
            poll = _context2.sent;
            _context2.next = 10;
            return _voteService["default"].recordVote((_req$session = req.session) === null || _req$session === void 0 || (_req$session = _req$session.user) === null || _req$session === void 0 ? void 0 : _req$session._id, pollId, option);
          case 10:
            _emitter["default"].emit(_events["default"].VOTE_CASTED, {
              pollId: poll.id,
              pollQuestion: poll.question,
              voterName: (_req$session2 = req.session) === null || _req$session2 === void 0 || (_req$session2 = _req$session2.user) === null || _req$session2 === void 0 ? void 0 : _req$session2.name.first
            });
