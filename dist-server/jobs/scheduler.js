...
var _agenda = _interopRequireDefault(require("../config/agenda"));
...
var scheduler = {
  sendPasswordResetMail: function () {
    ...
    function sendPasswordResetMail(_x) {
  ...
  dispatchPollCreatedJob: function () {
    var _dispatchPollCreatedJob = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(data) {
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return _agenda["default"].now(_events["default"].POLL_CREATED, data);
          case 2:
          case "end":
    ...
    function dispatchPollCreatedJob(_x3) {
