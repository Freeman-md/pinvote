...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } // jobs/handlers/mail-job-handler.js
var MailJobHandler = /*#__PURE__*/function () {
  function MailJobHandler() {
    _classCallCheck(this, MailJobHandler);
  }
  _createClass(MailJobHandler, null, [{
    ...
    value: function () {
      ...
      function sendPasswordResetEmail(_x) {
  ...
  return MailJobHandler;
}();
var _default = exports["default"] = MailJobHandler;