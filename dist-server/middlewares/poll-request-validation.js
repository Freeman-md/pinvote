...
exports.validatePollUpdate = exports.validatePoll = exports.validateOptionInPoll = exports.validateDateTime = void 0;
...
var validateOptionInPoll = exports.validateOptionInPoll = [(0, _expressValidator.body)('option').trim().notEmpty().custom( /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          req = _ref2.req;
          _context.next = 3;
          return _pollService["default"].getPollDetails(req.params.id);
        case 3:
          poll = _context.sent;
          if (poll) {
            _context.next = 6;
