...
router.get('/reset-password', _requestValidation.validateResetPasswordQueryParams, _authController.showResetPasswordPage);
...
router.post('/reset-password', _requestValidation.validateResetPassword, _authController.resetPassword);
